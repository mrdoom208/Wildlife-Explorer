...
app.use(cors({
  origin: (origin, callback) => {
    if (!origin || allowedOrigins.includes(origin) || allowedOrigins.some(allowed => origin?.endsWith(allowed))) {
      callback(null, true);
    } else {
      ...
      const seedAnimals = [
        {
          name: "Bengal Tiger",
          category: "mammals",
          image: "https://images.unsplash.com/photo-1556228570-65fa9986a3ac?w=400", // URL only
        ...
        },
        {
          name: "Indian Peafowl", 
          category: "birds",
          image: "https://images.unsplash.com/photo-1574194295394-f4dd879bd90c?w=400",
        ...
        },
        {
          ...
          category: "reptiles",
          image: "https://images.unsplash.com/photo-1605793184511-1f7a4e7cd1bd?w=400",
