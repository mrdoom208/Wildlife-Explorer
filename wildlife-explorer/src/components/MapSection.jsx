...
export const wildlifeReserves = [
  ...
  // ISLAND (Pink)
  { id: 10, name: "Komodo National Park", coords: { lat: -8.5435, lng: 119.4956 }, type: "island", animalId: 6, animals: ["Komodo Dragon"], description: "Dragon island." },
  { id: 11, name: "Madagascar Rainforest", coords: { lat: -20.25, lng: 47 }, type: "island", animalId: 9, animals: ["Cobra"], description: "Island endemics." },
  { id: 12, name: "Galapagos Islands", coords: { lat: -0.5, lng: -90.5 }, type: "island", animalId: 3, animals: ["Green Sea Turtle"], description: "Darwin's laboratory." },

  // MOUNTAIN (Green)
  { id: 13, name: "Denali National Park", coords: { lat: 63.0694, lng: -151.0072 }, type: "mountain", animalId: 8, animals: ["Polar Bear"], description: "Mount Denali." },
  { id: 14, name: "Himalayan Highlands", coords: { lat: 28.3949, lng: 84.1426 }, type: "mountain", animals: ["Snow Leopard"], description: "High altitude." },
  { id: 15, name: "Andes Cloud Forest", coords: { lat: -2.2, lng: -77.9 }, type: "mountain", animalId: 16, animals: ["Smalltooth Sawfish"], description: "Mountain biodiversity." }
];
...
export default function MapSection() {
  ...
  return (
    <section className="py-20 px-4 max-w-7xl mx-auto">
      ...
      >
        {['all', 'marine', 'terrestrial', 'freshwater', 'island', 'mountain'].map(type => (
          <motion.button
            key={type}
      ...
      >
        ...
        >
          ...
          {filteredReserves.map((reserve) => {
            let icon;
            switch(reserve.type) {
              case 'marine': icon = MarinePin; break;          // ✅ FIXED
              case 'freshwater': icon = FreshwaterPin; break;  // ✅ FIXED
              case 'island': icon = IslandPin; break;          // ✅ FIXED
              case 'mountain': icon = MountainPin; break;      // ✅ FIXED
              default: icon = TerrestrialPin;                  // ✅ FIXED
            }
      ...
      >
        ...
        <div className="flex items-center space-x-2 p-3 rounded-2xl bg-gradient-to-r from-violet-500/20 to-violet-400/20 border border-violet-500/30 hover:bg-violet-500/30 transition-all whitespace-nowrap flex-1 min-w-[140px]">
