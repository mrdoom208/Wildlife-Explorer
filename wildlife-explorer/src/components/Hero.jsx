...
export default function Hero() {
  return (
    <section className="pt-24 pb-20 md:pt-35 md:pb-35 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-r from-emerald-100 via-blue-100 to-purple-100"></div>
      <motion.div 
