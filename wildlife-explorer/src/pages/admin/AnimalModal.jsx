          ...
          >
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={onChange}
                    className="w-full p-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 cursor-pointer"
                    required
                  >
              ...
              <div>
                ...
                <div
                  className={`border-gray-300 border-2 border-dashed rounded-xl p-2  text-center transition-all duration-300 ease-in-out hover:border-green-400 hover:bg-gray-50${
                ...
                >
                  ...
                  >
                    {uploadingImage ? (
                      ...
                      <div className="relative group w-h-48 bg-green-50 ">
                        <img
                          src={imagePreview}
                          alt="Preview"
                        ...
                        {/*<CheckCircle
                          size={40}
                          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-green-400 z-10"
                        />*/}
                      </div>
                    ) : (
                      <>
