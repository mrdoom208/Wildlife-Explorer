    ...
    <div className="min-h-screen pt-24 pb-20">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-2xl font-bold mb-4 text-gray-900">Habitat Protection</h3>
            ...
            >
              ...
              <h3 className="text-2xl font-bold mb-4 text-gray-900">Species Recovery</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            >
              ...
              <h3 className="text-2xl font-bold mb-4 text-gray-900">Education Outreach</h3>
              <p className="text-gray-700 leading-relaxed">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.h2
            ...
            className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-emerald-600 via-blue-600 to-purple-600 bg-clip-text text-transparent"
          >
            Stay Updated
          </motion.h2>
          ...
          >
            Get the latest wildlife conservation news, discoveries, and success stories delivered straight to your inbox.
          </motion.p>
        </motion.div>
      ...
      <section className="pt-30 pb-20 px-4 max-w-4xl mx-auto" id="contact">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-2xl">
                ...
                <div>
                  <p className="font-semibold text-gray-900">Global Headquarters</p>
                  <p className="text-gray-700">Quezon City, Philippines</p>
                </div>
              </div>
              <a href="mailto:info@wildlifeexplorer.org" className="block w-full flex items-center space-x-4 p-4 bg-blue-50 rounded-2xl hover:bg-blue-100 transition-all group">
                <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                  <Mail className="w-6 h-6 text-blue-600" />
                </div>
                <div>
                  <p className="font-semibold text-gray-900">info@wildlifeexplorer.org</p>
                </div>
              </a>
            </div>
          </motion.div>
          ...
          >
            <h4 className="text-2xl font-bold mb-8 text-gray-900">Follow Our Journey</h4>
            <div className="flex justify-center space-x-6 pt-4">
              <a href="#" className="group p-4 bg-gray-100 rounded-2xl hover:bg-blue-500 hover:text-white transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-110" aria-label="Twitter">
                <Twitter className="w-8 h-8 group-hover:-rotate-12 transition-transform" />
              </a>
              <a href="#" className="group p-4 bg-gray-100 rounded-2xl hover:bg-pink-500 hover:text-white transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-110" aria-label="Instagram">
                <Instagram className="w-8 h-8 group-hover:-rotate-12 transition-transform" />
              </a>
              <a href="#" className="group p-4 bg-gray-100 rounded-2xl hover:bg-blue-600 hover:text-white transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-110" aria-label="Facebook">
