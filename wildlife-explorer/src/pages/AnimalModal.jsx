  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-white rounded-3xl max-w-4xl w-full max-h-[95vh] m-auto"
        ...
        <div className="p-4 md:p-8 max-h-[95vh] overflow-y-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-4 lg:gap-12">
            ...
            <div className="flex-1 flex flex-col w-full lg:w-auto">
              <a href={animal.image}>
                <div className="w-full h-48 min-h-64 sm:h-64 md:h-80 lg:h-96 flex-shrink-0 mb-4 md:mb-6 lg:mb-8 relative group">
                  <img
                    src={
                      animal.image ||
                    ...
                    alt={animal.name}
                    className="w-full h-full object-fit rounded-2xl shadow-2xl transition-all duration-300 group-hover:opacity-60"
                  />

                  <p className="absolute inset-0 flex items-center justify-center font-semibold opacity-0 group-hover:opacity-100 transition duration-300">
                    See Full Image
                  </p>
                </div>
              </a>
              <div className="grid grid-cols-2 gap-2 md:gap-3 lg:gap-4 flex-shrink-0">
                <div className="bg-green-50 p-3 md:p-4 lg:p-6 rounded-xl md:rounded-2xl">
                  <h4 className="font-semibold text-green-800 mb-1 text-xs md:text-sm lg:text-base">
                    Habitat
                  </h4>
                  <p className="text-xs md:text-sm text-wrap lg:text-base xl:text-lg truncate">
                    {animal.habitat || "🌍"}
                  </p>
                </div>
                <div className="bg-blue-50 p-3 md:p-4 lg:p-6 rounded-xl md:rounded-2xl">
                  <h4 className="font-semibold text-blue-800 mb-1 text-xs md:text-sm lg:text-base">
                    Diet
                  </h4>
                  <p className="text-xs md:text-sm lg:text-base xl:text-lg truncate">
